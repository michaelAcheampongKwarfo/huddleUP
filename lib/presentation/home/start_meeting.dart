...
import 'package:huddle_up_project/presentation/videoConference/start_conference.dart';
            ...
            AppButton(
              ...
              onTap: () {
                if (_userNameController.text == '' ||
                  ...
                  _conferenceManager.storeStartMeetingDetails(
                    context,
                    _titleController.text,
                    randomMeetingID,
                    DateTime.now(),
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => StartConferencePage(
                        conferenceID: randomMeetingID,
                        meetingTitle: _titleController.text.toString(),
                      ),
                    ),
                  );
